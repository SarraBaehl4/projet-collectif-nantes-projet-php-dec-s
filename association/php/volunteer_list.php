                ...
                <?php foreach ($benevoles as $benevole) : ?>
                    <tr class="hover:bg-gray-100 transition duration-200">
                        ...
                        <td class="py-3 px-4 flex space-x-2">
                            ...
                            <a href="volunteer_delete.php?id=<?= $benevole['id'] ?>" class="bg-red-600 hover:bg-red-700 text-white px-4 py-2 rounded-lg shadow-lg focus:outline-none focus:ring-2 focus:ring-red-500 transition duration-200" onclick="return confirm('Êtes-vous sûr de vouloir supprimer cette benevole ?');">
                                🗑️ Supprimer
                            </a>
                        </td>
                    </tr>
